...
fs.chmodSync(path.join(packageDir, "b", "p"), '777')
...
if(pkg.web){
    ...
    fu.writeFile(path.join(packageDir, "webpack.config.js"), fu.readFile(path.join("web", "webpack.config.js")))
    ...
    fu.writeFile(path.join(packageDir, "install"), fu.readFile(path.join("web", "install")))
    fs.chmodSync(path.join(packageDir, "install"), '777')
    fu.writeFile(path.join(packageDir, "install.bat"), fu.readFile(path.join("web", "install.bat")))
}